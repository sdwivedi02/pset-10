...
public class AddWord {
	...
	private void initialize() {
		...
		wordLabel.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		wordTextField.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		addWordLabel.setFont(new Font("Times New Roman", Font.PLAIN, 32));
		...
		posTextField.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		posLabel.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		definitionTextField.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		definitionLabel.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		synonymsTextField.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		synonymsLabel.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		antonymsTextField.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		antonymsLabel.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		closeWindowButton.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		addWordButton.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		synonymsAddButton.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		antonymsAddButton.setFont(new Font("Times New Roman", Font.PLAIN, 13));
		...
		addWordPOSbtn.setFont(new Font("Times New Roman", Font.PLAIN, 13));
